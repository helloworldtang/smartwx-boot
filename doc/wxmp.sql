...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`wxmp` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `wxcms_account_fans` (
  ...
  `subscribe_time` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `wx_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
