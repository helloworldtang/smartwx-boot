...
public class WxError implements Serializable {
    ...
    public static WxError fromJson(JSONObject jsonObject) {
        if (jsonObject == null) {
            return WxError.newBuilder().setErrorMsg("null").build();
        }
        return WxError.newBuilder().setErrorCode(jsonObject.getInteger("errcode")).setErrorMsg(jsonObject.getString("errmsg")).build();
    }
